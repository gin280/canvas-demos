console.log(123);
import {digit, a} from './component/digit.js';
...
let balls = [];
let colors = ['#33b5e5','#0099cc','#aa66cc','#9933cc','#99cc00','#ffbb33','#ff8800','#ff4444','#cc0000'];
...
function renderDigit(x,y,num,cxt) {
  ...
  for (let i of digit[num].keys()) {
    
    // console.log(i);
    
    for (let j of digit[num][i].keys()) {
